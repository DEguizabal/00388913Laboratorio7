...
void leerMallayCondiciones(mesh &m,char *filename){
    ...
    ifstream file;
    float VARtao,VARkappa,VARlambda,VARpsix,VARpsiy,VARdelta,VAReta;
    ...
    file >> VARtao >> VARkappa >> VARlambda >> VARpsix >> VARpsiy >> VARdelta >> VAReta;
    ...
    m.setParameters(VARtao,VARkappa,VARlambda,VARpsix,VARpsiy,VARdelta,VAReta);
