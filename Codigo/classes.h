...
enum parameters {TAO,KAPPA,LAMBDA,PSIX,PSIY,DELTA,ETA};
...
class mesh{
    ...
    public:
        void setParameters(float VARtao,float VARkappa, float VARlambda, float VARpsix, float VARpsiy, float VARdelta, float VAReta){
            parameters[TAO]=VARtao;
            parameters[KAPPA]=VARkappa;
            parameters[LAMBDA]=VARlambda;
            parameters[PSIX]=VARpsix;
            parameters[PSIY]=VARpsiy;
            parameters[DELTA]=VARdelta;
            parameters[ETA]=VAReta;
        }
